...
export class CommentServiceProxy {
     ...
     * @return Success
     */
    getAll(sorting: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<CommentDtoPagedResultDto> {
     ...
     * @return Success
     */
    create(body: CommentDto | undefined): Observable<CommentDto> {
     ...
     * @return Success
     */
    update(body: CommentDto | undefined): Observable<CommentDto> {
...
@Injectable()
export class LikeStatusServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    get(id: string | undefined): Observable<LikeStatusDto> {
        let url_ = this.baseUrl + "/api/services/app/LikeStatus/Get?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_: any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<LikeStatusDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<LikeStatusDto>><any>_observableThrow(response_);
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<LikeStatusDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
                let result200: any = null;
                let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
                result200 = LikeStatusDto.fromJS(resultData200);
                return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<LikeStatusDto>(<any>null);
    }
     ...
     * @return Success
     */
    getAll(sorting: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<LikeStatusDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/LikeStatus/GetAll?";
        if (sorting !== undefined && sorting !== null)
            url_ += "Sorting=" + encodeURIComponent("" + sorting) + "&";
        if (skipCount === null)
            throw new Error("The parameter 'skipCount' cannot be null.");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_: any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<LikeStatusDtoPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<LikeStatusDtoPagedResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<LikeStatusDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
                let result200: any = null;
                let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
                result200 = LikeStatusDtoPagedResultDto.fromJS(resultData200);
                return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<LikeStatusDtoPagedResultDto>(<any>null);
    }
     ...
     * @return Success
     */
    create(body: LikeStatusDto | undefined): Observable<LikeStatusDto> {
        let url_ = this.baseUrl + "/api/services/app/LikeStatus/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: HttpResponseBase): Observable<LikeStatusDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    update(body: LikeStatusDto | undefined): Observable<LikeStatusDto> {
        let url_ = this.baseUrl + "/api/services/app/LikeStatus/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<LikeStatusDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     */
    delete(id: string | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/LikeStatus/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
...
@Injectable()
export class PetitionServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    public Id: string;
     ...
     * @return Success
     */
    get(id: string | undefined): Observable<PetitionDto> {
        let url_ = this.baseUrl + "/api/services/app/Petition/Get?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_: any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PetitionDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PetitionDto>><any>_observableThrow(response_);
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<PetitionDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
                let result200: any = null;
                let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
                result200 = PetitionDto.fromJS(resultData200);
                return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PetitionDto>(<any>null);
    }
     ...
     * @return Success
     */
    getAll(sorting: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<PetitionDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Petition/GetAll?";
        if (sorting !== undefined && sorting !== null)
            url_ += "Sorting=" + encodeURIComponent("" + sorting) + "&";
        if (skipCount === null)
            throw new Error("The parameter 'skipCount' cannot be null.");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_: any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PetitionDtoPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PetitionDtoPagedResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<PetitionDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
                let result200: any = null;
                let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
                result200 = PetitionDtoPagedResultDto.fromJS(resultData200);
                return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PetitionDtoPagedResultDto>(<any>null);
    }
     ...
     * @return Success
     */
    create(body: PetitionDto | undefined): Observable<PetitionDto> {
        let url_ = this.baseUrl + "/api/services/app/Petition/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: HttpResponseBase): Observable<PetitionDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    update(body: PetitionDto | undefined): Observable<PetitionDto> {
        let url_ = this.baseUrl + "/api/services/app/Petition/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<PetitionDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     */
    delete(id: string | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Petition/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
...
export class CommentDto implements ICommentDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.petitionId = _data["petitionId"];
            this.auther = _data["auther"];
...
export class LikeStatusDto implements ILikeStatusDto {
    petitionId: string | undefined;
    like: boolean;
    disLike: boolean;
    ...
    constructor(data?: ILikeStatusDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): LikeStatusDto {
        data = typeof data === 'object' ? data : {};
        let result = new LikeStatusDto();
        result.init(data);
        return result;
    }
...
export interface ILikeStatusDto {
    petitionId: string | undefined;
    like: boolean;
    disLike: boolean;
    userId: string | undefined;
...
export class LikeStatusDtoPagedResultDto implements ILikeStatusDtoPagedResultDto {
    totalCount: number;
    items: LikeStatusDto[] | undefined;

    constructor(data?: ILikeStatusDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items.push(LikeStatusDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): LikeStatusDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new LikeStatusDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): LikeStatusDtoPagedResultDto {
        const json = this.toJSON();
        let result = new LikeStatusDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface ILikeStatusDtoPagedResultDto {
    totalCount: number;
    items: LikeStatusDto[] | undefined;
}
...
export class PetitionDtoPagedResultDto implements IPetitionDtoPagedResultDto {
    totalCount: number;
    items: PetitionDto[] | undefined;

    constructor(data?: IPetitionDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items.push(PetitionDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PetitionDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new PetitionDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): PetitionDtoPagedResultDto {
        const json = this.toJSON();
        let result = new PetitionDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface IPetitionDtoPagedResultDto {
    totalCount: number;
    items: PetitionDto[] | undefined;
}
