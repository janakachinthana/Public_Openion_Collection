...
using Abp.UI;
using Public_Opinion_Collection.Authentication.External;
using Public_Opinion_Collection.Authentication.JwtBearer;
...
namespace Public_Opinion_Collection.Controllers
{
    ...
    public class TokenAuthController : Public_Opinion_CollectionControllerBase
    {
