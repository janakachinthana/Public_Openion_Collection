...
namespace Public_Opinion_Collection.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = Public_Opinion_CollectionConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(Public_Opinion_CollectionDbContext context)
        {
            _context = context;
        }
