...
using Shouldly;
using Xunit;
using Public_Opinion_Collection.Sessions;

namespace Public_Opinion_Collection.Tests.Sessions
{
    public class SessionAppService_Tests : Public_Opinion_CollectionTestBase
    {
